...
# Using \$ to ensure it's literal $ in the Dockerfile, which the shell then turns into a literal $ for Nginx
...
# Generate Nginx config INTERNALLY to avoid any host-side corruption
# We use backslash escaping for newline to keep the RUN command as one line for printf
