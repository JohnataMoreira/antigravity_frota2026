        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <GlassCard key={doc.id} className="group relative overflow-hidden">
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="flex items-center gap-2 text-[10px] font-black text-muted-foreground uppercase tracking-widest">
                                    <span className="px-1.5 py-0.5 bg-gray-100 dark:bg-gray-800 rounded">{doc.type}</span>
                ...
                {!isLoading && documents.length === 0 && (
                    <div className="col-span-full py-12 flex flex-col items-center justify-center border-2 border-dashed border-gray-200 dark:border-gray-800 rounded-3xl opacity-50">
