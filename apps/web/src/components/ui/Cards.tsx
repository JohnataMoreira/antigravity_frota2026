 ...
 */
export function GlassCard({ children, className = '', gradient = false, transition = false, onClick }: GlassCardProps) {
    return (
        <div
            onClick={onClick}
            className={`
 ...
 `}
        ...
        >
            <div className="flex-1">
                <p className="text-sm font-bold text-muted-foreground/90 mb-2 uppercase tracking-wider">
                    {label}
                </p>
                {isLoading ? (
