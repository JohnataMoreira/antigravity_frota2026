    ...
    return (
        <div className="space-y-4">
            <div className="relative">
                <div className="flex items-center gap-2 bg-white dark:bg-gray-800 p-3 rounded-xl border-2 border-blue-100 dark:border-gray-700 focus-within:border-blue-500 transition-all">
                ...
                {suggestions.length > 0 && (
                    <div className="absolute top-full left-0 right-0 mt-2 bg-white dark:bg-gray-800 rounded-xl border shadow-xl z-50 max-h-60 overflow-y-auto">
                        {suggestions.map((s, i) => (
                            <button
                                key={i}
                                onClick={() => handleSelect(s)}
                                className="w-full text-left p-3 hover:bg-blue-50 dark:hover:bg-blue-900/20 text-xs font-medium border-b dark:border-gray-700 last:border-0"
                            >
                                {s.display_name}
                            </button>
                        ))}
