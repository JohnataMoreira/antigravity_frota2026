...
export function VehicleTyreMap({ tyres, config = '4x2' }: VehicleTyreMapProps) {
    const renderAxle = (axleNumber: number, type: 'STEER' | 'DRIVE' | 'SUPPORT') => {
        ...
        return (
            <div key={axleNumber} className="flex flex-col items-center gap-2 py-4 border-b last:border-0 dark:border-gray-800">
                ...
                <div className="flex items-center gap-12">
                    ...
                    {/* Axle bar */}
                    <div className="w-24 h-4 bg-gray-200 dark:bg-gray-800 rounded-full flex items-center justify-center">
                        <div className="w-20 h-0.5 bg-gray-300 dark:bg-gray-700" />
                    </div>
    ...
    return (
        <Card className="p-6 bg-gray-50/50 dark:bg-gray-900/50 border-none shadow-inner">
    ...
    return (
        <div className={`
            ...
            ${tyre
                ...
                : 'border-dashed border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-400'}
        `}>
            <Disc size={16} />
