...
export function AlertsWidget() {
 ...
 {hasIncidents && (
 <span className="px-3 py-1 bg-amber-500/20 text-amber-600 text-xs font-black rounded-full animate-pulse uppercase tracking-wider">
 ...
 <div key={incident.id} className="group p-4 bg-white rounded-2xl border border-gray-100 hover:border-amber-500/50 transition-all shadow-sm hover:shadow-md">
