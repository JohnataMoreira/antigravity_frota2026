...
export default function PurchasingList() {
  ...
  const { data: orders, isLoading } = useQuery({
    queryKey: ['purchase-orders', activeTab, dateFrom, dateTo, searchTerm],
    queryFn: () => {
      const params: any = { start: dateFrom, end: dateTo, search: searchTerm };
      if (activeTab !== 'ALL') params.status = activeTab;
      return purchasingService.getOrders(params);
    }
  });
