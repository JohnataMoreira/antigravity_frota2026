        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                    ...
                    <p className="text-muted-foreground/60 font-black uppercase tracking-[0.2em] mt-2 text-[10px]">Controle de Infrações e Conformidade de Frota</p>
                </div>
                <div className="flex items-center gap-3">
                    ...
                    />
                    <button className="bg-primary text-primary-foreground hover:bg-primary/90 px-8 py-4 rounded-2xl font-black text-[10px] uppercase tracking-widest flex items-center gap-2 transition-all active:scale-95 shadow-xl shadow-primary/20">
                        <Plus size={18} />
                        Registrar Multa
                    </button>
                </div>
