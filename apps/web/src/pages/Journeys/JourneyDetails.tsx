...
export function JourneyDetails() {
 ...
 <div className="absolute left-0 top-1.5 w-4 h-4 rounded-full bg-blue-600 border-2 border-white shadow-sm z-10" />
 <div className="absolute left-[7px] top-4 w-0.5 h-[calc(100%+20px)] bg-gray-200 " />
 ...
 <div className="mt-2 inline-flex items-center px-2 py-1 rounded bg-gray-100 text-[10px] font-black uppercase tracking-tighter">
 ...
 {journey.endTime && (
 <div className="relative pl-8 space-y-1">
 <div className="absolute left-0 top-1.5 w-4 h-4 rounded-full bg-green-500 border-2 border-white shadow-sm z-10" />
 ...
 <div key={item.itemName} className="flex items-center justify-between p-2 rounded-lg bg-gray-50/50 ">
