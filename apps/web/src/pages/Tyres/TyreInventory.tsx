            ...
            <Card className="border-none shadow-sm overflow-hidden">
                ...
                <div className="overflow-x-auto">
                    <table className="w-full">
                        <thead>
                            <tr className="text-left text-xs font-black uppercase tracking-widest text-muted-foreground border-b dark:border-gray-800">
                        ...
                        <tbody className="divide-y dark:divide-gray-800">
                            {isLoading ? (
                                ...
                                tyres?.map((tyre: any) => (
                                    <tr key={tyre.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
